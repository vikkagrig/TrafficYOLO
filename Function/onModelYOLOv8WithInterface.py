...
def create_rounded_button(parent, text, command, width=160, height=40, radius=12):
...
btn_open_canvas = create_rounded_button(top_frame, "Открыть изображение", open_image)
btn_open_canvas.pack(side="left", padx=(0, 15))

btn_detect_canvas = create_rounded_button(top_frame, "Найти светофор", detect_traffic_light)
btn_detect_canvas.pack(side="left", padx=(0, 15))

btn_save_canvas = create_rounded_button(top_frame, "Сохранить результат", save_result)
